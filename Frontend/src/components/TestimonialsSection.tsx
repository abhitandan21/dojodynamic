...
const testimonials = [
  {
    name: 'Avitsha Jena',
    role: 'Student',
    content: "The place feels like comfort now....all the people including the students and the sensei are very welcoming yet disciplined....we push boundaries we thought we could never cross...and watching same aspirants all around gives positive atmosphere where we grow and bloom together like a family .",
    rating: 5,
    years: '1 years',
  },
  {
    ...
    content: "I started training at 9, thinking I was too old to begin martial arts. Sensei  proved me wrong. The  program is challenging yet accessible, and the community here is incredibly supportive. Best decision I've ever made.",
    rating: 5,
    years: '4 years',
  },
  {
    ...
    content: "Training with the competition team has taken my karate to levels I never imagined. I've competed nationally and even internationally, all thanks to the elite coaching and rigorous training at Amaasa Dojo.",
    rating: 5,
    years: '2 years',
  },
  {
    ...
    content: "Earning my black belt at Amaasa Dojo was the proudest achievement of my life. The journey taught me that with persistence and proper guidance, anything is possible. The dojo has become my second family.",
    rating: 5,
    years: '4 years',
  },
  {
